...
export default function MasonryGrid({
  ...
  const renderL3 = (a: FeedItem, b: FeedItem, side: "right" | "left") => {
  ...
  const renderBlock = (blk: LayoutBlock) => {
    ...
    if (t === "L2" || t.startsWith("L2-")) {
      ...
      switch (t) {
        case "L2":
        case "L2-1":
          return renderL2(A, B, C, "right", true); // 우측, 위 1x2
        case "L2-2":
          return renderL2(A, B, C, "right", false); // 우측, 위 1x1
        case "L2-3":
          return renderL2(A, B, C, "left", true); // 좌측, 위 1x2
        case "L2-4":
          return renderL2(A, B, C, "left", false); // 좌측, 위 1x1
      }
    }
    ...
    if (t === "L3" || t.startsWith("L3-")) {
      ...
      switch (t) {
        case "L3":
        case "L3-1":
          return renderL3(A, B, "right"); // 얇은 컬럼 우측
        case "L3-2":
          return renderL3(A, B, "left"); // 얇은 컬럼 좌측
        case "L3-3":
          return renderL3(A, B, "right"); // 여유로 4변형 슬롯
        case "L3-4":
          return renderL3(A, B, "left");
      }
    }
